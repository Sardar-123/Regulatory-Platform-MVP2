...
f = open("C:/Users/mohds/Desktop/Project-2024/sepa_rulebook_project/Practice/data/.gemini.txt")
key = f.read()
...
def generate_impact_summary_and_test_scenario(change_type, element_path, old_type, new_type, annotation, api_key):
    ...
    test_scenario = response.text.strip()
...
uploaded_file1 = st.file_uploader("Upload XSD File 1", type="xsd")
uploaded_file2 = st.file_uploader("Upload XSD File 2", type="xsd")
...
if uploaded_file1 and uploaded_file2:
    ...
    if st.button("Generate Impact Summaries and Test Scenarios"):
        if gemini_api_key:
